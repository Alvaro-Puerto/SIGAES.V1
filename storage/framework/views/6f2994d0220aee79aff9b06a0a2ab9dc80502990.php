          ...
          <div class="col">
            <div class="card">
              ...
              <div class="card-header border-0 d-flex justify-content-between">
                ...
                <a href="<?php echo e(route('level.new')); ?>" class="btn btn-primary" >
                      ...
                      <td class="text-cemter">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('level.update', ['id'=>$level->id])); ?>">
                              <span><i class="fas fa-pencil-alt textr-primary"></i></span>
                              Editar
                            </a>
                            <form class="dropdown-item" action="<?php echo e(route('level.delete', $level->id)); ?>" method="post">
                              <?php echo csrf_field(); ?>
