            ...
            <div class="card card-profile shadow">
                ...
                <div class="card-body pt-0 pt-md-4">
                    ...
                    <div class="text-center">
                        ...
                        <div class="h5 font-weight-300">
                            <?php echo e($teacher->user->gender); ?>
                        ...
                        <hr class="my-4" />
                    <p><?php echo e($teacher->general_observation); ?></p>
        ...
        <div class="modal-body">
            <form method="POST" enctype="multipart/form-data" action="<?php echo e(url('student/update/photo')); ?>">
                ...
                <div class="form-group">
                    <input type="number" value=<?php echo e($teacher->id); ?> class="custom-file-input" hidden name="id" >
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alvar\Documents\SIGAES.V1\resources\views/teacher_detail.blade.php ENDPATH**/ ?>