              ...
              <div class="card-header border-0 ">
                <div class="row">
                  ...
                  <div class="col-8 d-flex justify-content-end">
                    ...
                    <a href= <?php echo e(url('student/create', [])); ?>  class="btn btn-primary"><span class="fa fa-plus"></span> Nuevo tutor</a>
                  </div>
                </div>
              ...
              <div class="table-responsive">
                <table class="table align-items-center table-flush" id="table-student">
                  ...
                  <tbody class="list" id="tbody-student">
                    <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <th scope="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alvar\Documents\SIGAES.V1\resources\views/list_parent.blade.php ENDPATH**/ ?>